...
export const CalendarModal = () => {
  ...
  const [endDate, setEndDate] = useState( nowPlus1h.toDate() );
  ...
  return (
    <Modal
      ...
      style={ customStyles }
      // contentLabel="Example Modal"//no usamos
      //agregado
      closeTimeoutMS={200}
      className="modal"
      ...
      >
          ...
          <div className="form-group">
              ...
              <DateTimePicker 
                ...
                value={ endDate }
                minDate={ startDate } //TODO: this produce an error, remind!
                format="dd/MM/y h:mm a"
                amPmAriaLabel="Select AM/PM" //TODO: i dont know how to use this
              />
          </div>
